...
let achat=parseFloat(row.querySelector(".achat").value)||0;

let coffre=parseFloat(row.querySelector(".coffre").value)||0;

let caisse=parseFloat(row.querySelector(".caisse").value)||0;

let reserve=parseFloat(row.querySelector(".reserve").value)||0;

let somme=coffre+caisse+reserve;

let etat=row.querySelector(".etat");

if(achat===somme){

etat.innerHTML="✅";

etat.className="etat status-ok";
...
let diff=achat-somme;

etat.innerHTML="❌ "+diff;

etat.className="etat status-error";
